...
/**
 * Object for a solid circle member
 * 
 * @author Blake M.
 * 
 * @version 1.0 
 * May 16, 2025 
 * - added circle section constructor 
...
public class CircleSection {
	 ...
	 */
	public CircleSection(double d, int material, double L, double k) {
	...
	public double CompresiveMember() {
		...
		double J = 1 / 2 * Math.PI * Math.pow(d / 2, 4);
		double Cw = 0;
